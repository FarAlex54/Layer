  ...
  const services = ([
    {
      ...
      description:
        [ {
            id: 1,
            value: "имеем практический опыт прохождения полного цикла выездных налоговых проверок"
          },
          {
            id: 2,
            value: "добиваемся правовыми методами максимально приемлемых формулировок Акта ВНП"
          },
          {
            id: 3,
            value: "пунктик просто для проверки, вдруг будут дополнять"
          }
        ],
